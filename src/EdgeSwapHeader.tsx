const EdgeSwapHeader: React.FC = () => {
  return (
    // Ana Kapsayıcı
    <div className="flex items-center bg-[#0a0e17] p-3 rounded-xl w-fit select-none">
      
      {/* =============================================
          İKON KAPSAYICISI (Group Class'ı burada!)
          =============================================
          - 'group': Alt elemanların hover durumunu tetikler.
          - 'z-50': İkonun her şeyin üstünde olmasını garantiler.
      */}
      <div className="relative w-12 h-12 flex-shrink-0 cursor-pointer group z-50 mr-3">
        
        {/* 1. LOGO (Varsayılan görünür, Hover olunca gizlenir) 
           --------------------------------------------------
           group-hover:opacity-0 -> Mouse gelince silin
           group-hover:scale-75  -> Mouse gelince küçül
        */}
        <svg
          viewBox="0 0 100 100"
        ...
        {/* 2. FOK BALIĞI (Varsayılan gizli, Hover olunca görünür) 
           -----------------------------------------------------
           opacity-0 -> Başlangıçta görünmez
           group-hover:opacity-100 -> Mouse gelince görün
        */}
        <svg
          viewBox="0 0 100 100"
          className="absolute inset-0 w-full h-full transform transition-all duration-500 ease-in-out
      ...
      <div className="flex flex-col">
        <div className="flex items-center space-x-2">
          <h1 className="text-lg font-bold text-white tracking-wide">
            <span className="text-blue-400">Edge</span>Swap
          </h1>
          <span className="px-2 py-0.5 text-[10px] font-bold text-teal-400 border border-teal-400 rounded-full tracking-wider">
            PRO
          </span>
        </div>
        <p className="text-[10px] font-semibold text-gray-400 flex items-center tracking-wider mt-0.5">
